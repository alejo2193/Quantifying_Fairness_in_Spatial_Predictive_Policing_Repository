...
class GaussianEdgeCorrectGrid(GaussianBase, _EdgeCorrect):
    ...
    def points_to_grid_space(self, pt):
        ...
        pts = _np.floor_divide(pts, _np.asarray([self._grid.xsize, self._grid.ysize])).astype(int)
        return pts
    ...
    def correction_factor(self, pt):
        ...
        pts = _np.floor_divide(pts, _np.asarray([self._grid.xsize, self._grid.ysize])[None,None,:]).astype(int)
